...
<div class="welcome-carousel">
  <div class="message-container">
    <h1>¡Busca un plan para empezar</h1>
    <div class="saludo">
      <h2>Y empieza tu cambio hoy mismo!</h2>
    </div>
  </div>
    ...
    <div class="buttons-container">
      <div class="button1-animation">
        <button class="button1" onclick="Adicional()">
          <h2>Plan mensual</h2>
          <h1>Q 200.00</h1>
          <ul>
      ...
      <div class="button2-animation">
        <button class="button2" onclick="Adicional()">
          <h2>Plan anual</h2>
          <h1>Q 2,200.00</h1>
          <ul>
            <h3>Horario de 4a.m. a 11p.m.</h3>
    ...
    <div class="button3-animation">
      <button class="button3" onclick="Adicional()">
          <h2>Plan UNIFIT</h2>
...
<script>
  function Adicional() {
    alert("Puedes adquirir este plan o preguntar por información adicional del mismo en cualquiera de nuestras dos sedes")
  }
</script>
